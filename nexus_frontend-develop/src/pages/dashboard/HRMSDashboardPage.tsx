...
//     <Card
//       size="small"
//       style={{ borderRadius: 12, border: "1px solid var(--bms-border)", height: "100%", background: "var(--bms-surface)" }}
...
//       }}
//       style={{ borderRadius: 12, border: `1px solid ${borderColor}`, height: "100%", background: "var(--bms-surface)" }}
//     >
//       {children}
//     </Card>
//   );
